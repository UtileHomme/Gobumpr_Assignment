...
<link rel="stylesheet" href="{{ asset('restaurant/mdtimepicker.css') }}">

<link href="{{ asset('restaurant/footable.core.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('restaurant/footable.metro.css') }}" rel="stylesheet" type="text/css" />
